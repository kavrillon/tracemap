...
export function FilesUpload() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 left-1/2 flex -translate-x-1/2 flex-col items-center justify-center md:bottom-12">
        <div className="flex flex-col items-center justify-center">
          ...
          {pending && (
            <div role="status">
              <svg
                aria-hidden="true"
                className="mb-4 h-8 w-8 animate-spin fill-white text-gray-200 dark:text-gray-600"
                viewBox="0 0 100 101"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
